...
#req_maxturn 5
#req_indepok 1
#req_maxpop 250 -- Cuts off at 2800 Population... give or take
#req_pop0ok
#msg "This province was too low in pop. Have some more!"
#incpop 50 -- Adds 500 Population, +- 25%
#nolog
#notext
#end
...
#req_maxturn 5
#req_indepok 1
#req_maxpop 350 -- Cuts off at 3800 Population... give or take
#req_pop0ok
#msg "This province was too low in pop. Have some more!"
#incpop 50 -- Adds 500 Population, +- 25%
#nolog
...
#req_maxturn 5
#req_indepok 1
#req_maxpop 450 -- Cuts off at 4800 Population... give or take
#req_pop0ok
#msg "This province was too low in pop. Have some more!"
#incpop 50 -- Adds 500 Population, +- 25%
#nolog
...
-- Remove all fly sprites end

-- Swarm bugs destroy armor

#selectweapon 740 -- Tiny bite
#secondaryeffectalways 174 -- Star of Heroes effect
#end

#selectweapon 739 -- Tiny sting
#secondaryeffectalways 174 -- Star of Heroes effect
#end
...
#selectweapon 575 -- Tiny slap
#secondaryeffectalways 174 -- Star of Heroes effect
#end

-- Swarm bugs destroy armor end
...
#selectspell 169 -- Divine Blessing
#school -1
#end

#selectspell 284 -- Divine Blessing
#school -1
#end

#selectspell 287 -- Divine Blessing
#school -1
#end

#selectspell 290 -- Divine Blessing
#school -1
#end

#selectspell 315 -- Divine Blessing
#school -1
#end

#selectspell 319 -- Divine Blessing
#school -1
#end

#selectspell 322 -- Divine Blessing
#school -1
#end

-- Remove blessing etc finish

-- All gem gen globals RL 0 and skill 1 and 0 gems
...
-- #selectspell 1110 -- Blood Vortex too stronk
-- #researchlevel 0
-- #pathlevel 0 1
-- #fatiguecost 0
-- #end

-- All gem gen globals RL 0 skill 1 0 gems end

-- Earth elemental double hp and trample swallow
...
-- End buff earth elemental

-- Send (lesser) horror is permanent and aligned
-- #selectspell 1087
-- #effect 10037
-- #end
-- #selectspell 1123
...
-- End send (lesser) horror is permanent and aligned but when you make it permanent and aligned you only get the commander which is p trash

-- Start salt vulnerability for water elementals and lake queens
...
-- End salt vul for elementals and lake queen
-- Start messing with scales
#misfortune 30
#luckevents 20
#eventisrare 30
#tempscalecap 6
#deathincome 0
-- end messing with scales
-- New AoE Control the Dead and Twist Fate
#newspell
#copyspell 1019 -- Control the dead
#name "Control More Dead"
#researchlevel 6
#pathlevel 1 3
#aoe 10004
#end
...
#dmg 5
#end
--Undead get death power, animals get growth power
